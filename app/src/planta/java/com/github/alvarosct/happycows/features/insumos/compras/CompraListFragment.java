...
public class CompraListFragment extends BaseFragment implements IAdapterDetail {

    protected SuperRecyclerView rvData;
    protected CompraAdapter adapter;
    ...
    public void openDetail(int id) {
        Intent intent = new Intent(getContext(), DetalleCompraListActivity.class);
...
//    PRESENTER METHODS
    ...
    public void listEntitiesLocal() {
        ...
        adapter = new CompraAdapter(entityList, this);
