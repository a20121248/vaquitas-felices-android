...
public class ProductoSelectAdapter extends RecyclerView.Adapter<ProductoSelectAdapter.ViewHolder> {
    protected List<Producto> objList;
    protected IDetail<Producto> iDetail;

    public ProductoSelectAdapter(IDetail<Producto> iAdapterDetail, List<Producto> objList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final Producto obj = objList.get(position);
