...
public class NecesidadesRegistrarAdapter extends RecyclerView.Adapter<NecesidadesRegistrarAdapter.ViewHolder> {
    protected List<ProductoItem> objList;
    private Context context;

    public NecesidadesRegistrarAdapter(Context context, List<ProductoItem> objList) {
